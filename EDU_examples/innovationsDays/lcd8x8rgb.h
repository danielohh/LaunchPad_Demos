...
#define bigX 15                  // Number of MOD-LED8x8RGB in columns
...
unsigned char sdelay = 50;
const char chipSelectPin = 2;
...
//----------------------------------------------------------------------------------------------
void scrollStringColor(unsigned char c[], boolean directions, char pickColor) { //draw a scrolling string
      color = pickColor;
      int len;
      for(len=0;c[len];len++);
